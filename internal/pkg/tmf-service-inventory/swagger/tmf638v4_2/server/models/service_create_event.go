...
//
// swagger:model ServiceCreateEvent
...
func (m *ServiceCreateEvent) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ServiceCreateEvent) validateEvent(formats strfmt.Registry) error {
...
func (m *ServiceCreateEvent) validateEventTime(formats strfmt.Registry) error {
...
func (m *ServiceCreateEvent) validateTimeOcurred(formats strfmt.Registry) error {
...
// ContextValidate validate this service create event based on the context it is used
func (m *ServiceCreateEvent) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ServiceCreateEvent) contextValidateEvent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ServiceCreateEvent) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ServiceCreateEvent) UnmarshalBinary(b []byte) error {
	var res ServiceCreateEvent
