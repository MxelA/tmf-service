...
//
// swagger:model ServiceDeleteEvent
...
// Validate validates this service delete event
func (m *ServiceDeleteEvent) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ServiceDeleteEvent) validateEvent(formats strfmt.Registry) error {
...
func (m *ServiceDeleteEvent) validateEventTime(formats strfmt.Registry) error {
...
func (m *ServiceDeleteEvent) validateTimeOcurred(formats strfmt.Registry) error {
...
// ContextValidate validate this service delete event based on the context it is used
func (m *ServiceDeleteEvent) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ServiceDeleteEvent) contextValidateEvent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ServiceDeleteEvent) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ServiceDeleteEvent) UnmarshalBinary(b []byte) error {
	var res ServiceDeleteEvent
