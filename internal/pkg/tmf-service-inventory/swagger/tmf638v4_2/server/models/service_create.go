...
// ServiceCreate Service is a base class for defining the Service hierarchy. All Services are characterized as either being possibly visible and usable by a Customer or not. This gives rise to the two subclasses of Service: CustomerFacingService and ResourceFacingService.
// Skipped properties: id,href,operatingStatus,operatingStatusContextUpdate
//
// swagger:model Service_Create
...
func (m *ServiceCreate) validateAtSchemaLocation(formats strfmt.Registry) error {
...
func (m *ServiceCreate) validateEndDate(formats strfmt.Registry) error {
...
func (m *ServiceCreate) validateExternalIdentifier(formats strfmt.Registry) error {
...
func (m *ServiceCreate) validateFeature(formats strfmt.Registry) error {
...
func (m *ServiceCreate) validateNote(formats strfmt.Registry) error {
...
func (m *ServiceCreate) validatePlace(formats strfmt.Registry) error {
...
func (m *ServiceCreate) validateRelatedEntity(formats strfmt.Registry) error {
...
func (m *ServiceCreate) validateRelatedParty(formats strfmt.Registry) error {
...
func (m *ServiceCreate) validateServiceCharacteristic(formats strfmt.Registry) error {
...
func (m *ServiceCreate) validateServiceDate(formats strfmt.Registry) error {
...
func (m *ServiceCreate) validateServiceOrderItem(formats strfmt.Registry) error {
...
func (m *ServiceCreate) validateServiceRelationship(formats strfmt.Registry) error {
...
func (m *ServiceCreate) validateServiceSpecification(formats strfmt.Registry) error {

	if err := validate.Required("serviceSpecification", "body", m.ServiceSpecification); err != nil {
		return err
	}
...
func (m *ServiceCreate) validateStartDate(formats strfmt.Registry) error {
...
func (m *ServiceCreate) validateState(formats strfmt.Registry) error {
...
func (m *ServiceCreate) validateSupportingResource(formats strfmt.Registry) error {
...
func (m *ServiceCreate) validateSupportingService(formats strfmt.Registry) error {
...
func (m *ServiceCreate) contextValidateExternalIdentifier(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ServiceCreate) contextValidateFeature(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ServiceCreate) contextValidateNote(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ServiceCreate) contextValidatePlace(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ServiceCreate) contextValidateRelatedEntity(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ServiceCreate) contextValidateRelatedParty(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ServiceCreate) contextValidateServiceCharacteristic(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ServiceCreate) contextValidateServiceOrderItem(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ServiceCreate) contextValidateServiceRelationship(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ServiceCreate) contextValidateServiceSpecification(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ServiceCreate) contextValidateState(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ServiceCreate) contextValidateSupportingResource(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ServiceCreate) contextValidateSupportingService(ctx context.Context, formats strfmt.Registry) error {
