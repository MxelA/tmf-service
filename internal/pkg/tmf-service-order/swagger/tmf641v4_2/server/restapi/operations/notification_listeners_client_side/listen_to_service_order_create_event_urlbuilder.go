...
func (o *ListenToServiceOrderCreateEventURL) Build() (*url.URL, error) {
	...
	var _path = "/listener/serviceOrderCreateEvent"
...
func (o *ListenToServiceOrderCreateEventURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListenToServiceOrderCreateEventURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListenToServiceOrderCreateEventURL")
	}
