...
func (o *ListenToServiceOrderDeleteEventURL) Build() (*url.URL, error) {
	...
	var _path = "/listener/serviceOrderDeleteEvent"
...
func (o *ListenToServiceOrderDeleteEventURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListenToServiceOrderDeleteEventURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListenToServiceOrderDeleteEventURL")
	}
