...
func (o *ListenToServiceOrderJeopardyEventURL) Build() (*url.URL, error) {
	...
	var _path = "/listener/serviceOrderJeopardyEvent"
...
func (o *ListenToServiceOrderJeopardyEventURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListenToServiceOrderJeopardyEventURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListenToServiceOrderJeopardyEventURL")
	}
