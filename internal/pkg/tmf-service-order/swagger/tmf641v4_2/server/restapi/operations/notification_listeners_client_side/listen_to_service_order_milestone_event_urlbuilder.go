...
func (o *ListenToServiceOrderMilestoneEventURL) Build() (*url.URL, error) {
	...
	var _path = "/listener/serviceOrderMilestoneEvent"
...
func (o *ListenToServiceOrderMilestoneEventURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListenToServiceOrderMilestoneEventURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListenToServiceOrderMilestoneEventURL")
	}
