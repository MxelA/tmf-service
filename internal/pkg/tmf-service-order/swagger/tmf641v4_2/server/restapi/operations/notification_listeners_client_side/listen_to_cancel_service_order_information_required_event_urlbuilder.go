...
func (o *ListenToCancelServiceOrderInformationRequiredEventURL) Build() (*url.URL, error) {
	...
	var _path = "/listener/cancelServiceOrderInformationRequiredEvent"
...
func (o *ListenToCancelServiceOrderInformationRequiredEventURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListenToCancelServiceOrderInformationRequiredEventURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListenToCancelServiceOrderInformationRequiredEventURL")
	}
