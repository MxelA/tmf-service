...
func (o *ListenToServiceOrderStateChangeEventURL) Build() (*url.URL, error) {
	...
	var _path = "/listener/serviceOrderStateChangeEvent"
...
func (o *ListenToServiceOrderStateChangeEventURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListenToServiceOrderStateChangeEventURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListenToServiceOrderStateChangeEventURL")
	}
