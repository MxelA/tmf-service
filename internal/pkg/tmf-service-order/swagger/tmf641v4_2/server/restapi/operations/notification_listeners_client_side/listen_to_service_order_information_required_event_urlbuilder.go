...
func (o *ListenToServiceOrderInformationRequiredEventURL) Build() (*url.URL, error) {
	...
	var _path = "/listener/serviceOrderInformationRequiredEvent"
...
func (o *ListenToServiceOrderInformationRequiredEventURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListenToServiceOrderInformationRequiredEventURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListenToServiceOrderInformationRequiredEventURL")
	}
