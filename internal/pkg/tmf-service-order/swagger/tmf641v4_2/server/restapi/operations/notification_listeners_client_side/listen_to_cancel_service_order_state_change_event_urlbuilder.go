...
func (o *ListenToCancelServiceOrderStateChangeEventURL) Build() (*url.URL, error) {
	...
	var _path = "/listener/cancelServiceOrderStateChangeEvent"
...
func (o *ListenToCancelServiceOrderStateChangeEventURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListenToCancelServiceOrderStateChangeEventURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListenToCancelServiceOrderStateChangeEventURL")
	}
