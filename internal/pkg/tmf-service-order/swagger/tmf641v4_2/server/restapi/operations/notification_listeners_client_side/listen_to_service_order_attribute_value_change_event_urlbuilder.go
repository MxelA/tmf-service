...
func (o *ListenToServiceOrderAttributeValueChangeEventURL) Build() (*url.URL, error) {
	...
	var _path = "/listener/serviceOrderAttributeValueChangeEvent"
...
func (o *ListenToServiceOrderAttributeValueChangeEventURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListenToServiceOrderAttributeValueChangeEventURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListenToServiceOrderAttributeValueChangeEventURL")
	}
