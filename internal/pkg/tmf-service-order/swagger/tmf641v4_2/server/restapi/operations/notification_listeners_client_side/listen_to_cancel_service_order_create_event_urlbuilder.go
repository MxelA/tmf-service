...
func (o *ListenToCancelServiceOrderCreateEventURL) Build() (*url.URL, error) {
	...
	var _path = "/listener/cancelServiceOrderCreateEvent"
...
func (o *ListenToCancelServiceOrderCreateEventURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ListenToCancelServiceOrderCreateEventURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ListenToCancelServiceOrderCreateEventURL")
	}
